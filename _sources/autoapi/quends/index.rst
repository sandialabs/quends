...
.. py:class:: DataStream(df: pandas.DataFrame, _history=None)
   ...
   :ivar df: The underlying time-series data, with 'time' as one column.
   :vartype df: pandas.DataFrame
   :ivar _history: Records of all operations performed, including their options.

   :vartype _history: list of dict
   ...
   .. py:method:: head(n=5)
      ...
      :Parameters: **n** (*int, optional*) -- Number of rows to return. Defaults to 5.

      :returns: *pandas.DataFrame* -- The first `n` rows of the DataFrame.
   ...
   .. py:method:: variables()
      ...
      :returns: *Index* -- ColumnIndex of variable names in `self.df`.
   ...
   .. py:method:: trim(column_name, batch_size=10, start_time=0.0, method='std', threshold=None, robust=True)
      ...
      :Parameters: * **column_name** (*str*) -- Name of the signal column to analyze for steady-state.
                   * **batch_size** (*int, default=10*) -- Window size for steady-state detection.
                   * **start_time** (*float, default=0.0*) -- Earliest time to consider in the analysis.
                   * **method** (*{'std', 'threshold', 'rolling_variance'}, default='std'*) -- Detection method:
                   ...
                   * **threshold** (*float or None*) -- Threshold value for the 'threshold' or 'rolling_variance' methods.
                   * **robust** (*bool, default=True*) -- Use median/MAD instead of mean/std for the 'std' method.

      :returns: *DataStream* -- New DataStream containing the trimmed data, or empty if trimming failed.
   ...
   .. py:method:: find_steady_state_std(data, column_name, window_size=10, robust=True)
      ...
      :Parameters: * **data** (*DataFrame*) -- Subset of the original df (must include 'time' and signal column).
                   * **column_name** (*str*)
                   * **window_size** (*int*) -- Number of samples to evaluate the steady-state criteria.
                   * **robust** (*bool*) -- If True, use median and MAD; else mean and std.

      :returns: *float or None* -- Detected start time of steady-state, or None if not found.
   ...
   .. py:method:: find_steady_state_rolling_variance(data, column_name, window_size=50, threshold=0.1)
      ...
      :Parameters: * **data** (*DataFrame*)
                   * **column_name** (*str*)
                   * **window_size** (*int*)
                   * **threshold** (*float*) -- Fraction of mean rolling std below which to consider steady-state.

      :returns: *float or None* -- Time of first below-threshold variance, or None.
   ...
   .. py:method:: find_steady_state_threshold(data, column_name, window_size, threshold)
      ...
      :Parameters: * **data** (*DataFrame*)
                   * **column_name** (*str*)
                   * **window_size** (*int*)
                   * **threshold** (*float*) -- Std threshold under which to mark steady-state.
   ...
   .. py:method:: effective_sample_size(column_names=None, alpha=0.05)
      ...
      :Parameters: * **column_names** (*str or list of str or None*) -- Columns to compute ESS for; defaults to all except 'time'.
                   * **alpha** (*float*) -- Significance level for autocorrelation cutoff.

      :returns: *dict* -- {'results': {col: ESS_int or message}, 'metadata': history}
   ...
   .. py:method:: ess_robust(column_names=None, rank_normalize=False, min_samples=8, return_relative=False)
      ...
      :returns: *dict* -- {'results': {col: ESS or tuple}, 'metadata': history}
   ...
   .. py:method:: compute_statistics(column_name=None, ddof=1, method='non-overlapping', window_size=None)
      ...
      :returns: *dict* -- {col: {statistics...}, 'metadata': history}
   ...
   .. py:method:: is_stationary(columns)
      ...
      :returns: *dict* -- {column: True if stationary (p<0.05), else False or error message}
...
.. py:class:: Exporter(output_dir='exported_results')
   ...
   .. py:method:: to_dataframe(data)
      ...
      :Parameters: **data** -- DataFrame, dict, NumPy array, or any structure convertible to DataFrame.
   ...
   .. py:method:: to_dictionary(data)
      ...
      :Parameters: **data** -- dict, DataFrame, or NumPy array.

      :returns: *dict* -- The converted dictionary (native types).
   ...
   .. py:method:: to_numpy(data)
      ...
      :Parameters: **data** -- np.ndarray, DataFrame, or dict.
   ...
   .. py:method:: to_json(data)
      ...
      :Parameters: **data** -- DataFrame, dict, or NumPy array.
   ...
   .. py:method:: display_dataframe(data, head=None)
      ...
      :Parameters: * **data** -- Data convertible to DataFrame.
   ...
   .. py:method:: display_dictionary(data)
      ...
      :Parameters: **data** -- Data convertible to dictionary.
   ...
   .. py:method:: display_numpy(data)
      ...
      :Parameters: **data** -- Data convertible to a NumPy array.
   ...
   .. py:method:: display_json(data)
      ...
      :Parameters: **data** -- Data convertible to JSON.
   ...
   .. py:method:: save_dictionary(data, file_name='data_dictionary.json')
      ...
      :Parameters: * **data** -- Data convertible to a dictionary.
...
.. py:class:: Plotter(output_dir='results_figures')
   ...
   .. py:method:: format_dataset_name(dataset_name)
      ...
      :Parameters: **dataset_name** (*str*) -- The original dataset name.

      :returns: *str* -- A formatted dataset name.
   ...
   .. py:method:: trace_plot(data, variables_to_plot=None, save=False)
      ...
      :Parameters: * **data** (*DataStream or dict*) -- A DataStream instance or dictionary of DataFrames.
   ...
   .. py:method:: ensemble_trace_plot(data, variables_to_plot=None, save=False)
      ...
      :Parameters: * **data** (*DataStream or dict*) -- A DataStream instance or dictionary of DataFrames representing ensemble members.
                   * **variables_to_plot** (*list, optional*) -- List of variables to plot. If None,
                     all columns (except 'time') from the first DataFrame are used.
   ...
   .. py:method:: steady_state_automatic_plot(data, variables_to_plot=None, batch_size=10, start_time=0.0, method='std', threshold=None, robust=True, save=False)
      ...
      :Parameters: * **data** (*DataStream or dict*) -- A DataStream instance or a dictionary of DataFrames.
                   * **variables_to_plot** (*list, optional*) -- List of variables to plot. If None,
                     all columns (except 'time') from the first DataFrame are used.
   ...
   .. py:method:: plot_acf(data, alpha=0.05, column=None, ax=None)
      ...
      :Parameters: * **data** (*DataStream or array-like*) -- The data to plot.
   ...
   .. py:method:: plot_acf_ensemble(ensemble_obj, alpha=0.05, column=None)
      ...
      :Parameters: * **ensemble_obj** (*Ensemble*) -- An Ensemble instance containing DataStream members.
                   * **alpha** (*float*) -- Significance level for the confidence interval (default: 0.05).
   ...
   .. py:method:: ensemble_steady_state_automatic_plot(ensemble_obj, variables_to_plot=None, batch_size=10, start_time=0.0, method='std', threshold=None, robust=True, save=False)
      ...
      :Parameters: * **ensemble_obj** (*Ensemble*) -- An Ensemble instance.
...
.. py:function:: from_csv(file, variables=None)
   ...
   :returns: *DataStream* -- A DataStream object containing the data from the CSV file.
...
.. py:function:: from_dict(data_dict, variables=None)
   ...
   :Parameters: * **data_dict** (*dict*) -- A dictionary where keys are column names and values are lists or arrays of data.
                * **variables** (*list, optional*) -- List of variable names (columns) to include.
                  If None, all dictionary keys are used.

   :returns: *DataStream* -- A DataStream object containing the data from the dictionary.
...
.. py:function:: from_json(file, variables=None)
   ...
   :returns: *DataStream* -- A DataStream object containing the data from the JSON file.
...
.. py:function:: from_netcdf(file, variables=None)
   ...
   :returns: *DataStream* -- A DataStream object containing the data as a pandas DataFrame.
...
.. py:function:: from_numpy(np_array, variables=None)
   ...
   :Parameters: * **np_array** (*np.ndarray*) -- A 1D or 2D NumPy array.
   ...
   :returns: *DataStream* -- A DataStream object containing the NumPy array data.
